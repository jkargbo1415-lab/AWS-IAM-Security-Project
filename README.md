...
![01](screenshots/01-john-admin-user-review.png)
### 02-Admin User Created
![02](screenshots/02-john-admin-created.png)
### 03-MFA Enabled
![03](screenshots/03-john-admin-mfa-enabled.png)
### 04-CloudTrail IAM Events
![04](screenshots/04-cloudtrail-iam-events.png)
### 05-ReadOnly Policy Assigned
![05](screenshots/05-readonly-policy-assigned.png)
### 06-ReadOnly User Review
![06](screenshots/06-readonly-user-review.png)
### 07-Admin Permissions
![07](screenshots/07-john-admin-permissions.png)
### 08-IAM User List
![08](screenshots/08-iam-users-list.png)
